...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2021 a las 03:52:35
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_create_customer` ()  BEGIN
	select * from tbl_customer;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_create_user` ()  BEGIN
	select * from tbl_user;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_customer` ()  BEGIN
	select * from tbl_customer;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_product` (IN `idProductD` INT(11))  BEGIN 
DELETE FROM tbl_product WHERE p_id=idProductD; 
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_sizes` (IN `idSizeD` INT(11))  BEGIN 
	DELETE FROM tbl_size
WHERE size_id=idSizeD;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_user` ()  BEGIN
	select * from tbl_user;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_edit_customer` ()  BEGIN
	select * from tbl_customer;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_edit_product` (IN `p_idE` INT(11), IN `p_nameE` VARCHAR(255), IN `p_old_priceE` VARCHAR(10), IN `p_current_priceE` VARCHAR(10), IN `p_qtyE` INT(10), IN `p_descriptionE` TEXT, IN `p_short_descriptionE` TEXT, IN `p_featureE` TEXT, IN `p_conditionE` TEXT, IN `p_return_policyE` TEXT, IN `p_is_featuredE` INT(1), IN `p_is_activeE` INT(1), IN `ecat_idE` INT(11))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_edit_sizes` (IN `sizeIdE` INT(11), IN `sizeNameE` VARCHAR(255))  BEGIN 
UPDATE tbl_size SET size_name=sizeNameE WHERE size_id=sizeIdE; 
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_edit_user` ()  BEGIN
	select * from tbl_user;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_product` (IN `_p_name` VARCHAR(255), IN `_p_old_price` VARCHAR(10), IN `_p_current_price` VARCHAR(10), IN `_p_qty` INT(10), IN `_p_featured_photo` VARCHAR(255), IN `_p_description` TEXT, IN `_p_short_description` TEXT, IN `_p_feature` TEXT, IN `_p_condition` TEXT, IN `_p_return_policy` TEXT, IN `_p_total_view` INT(11), IN `_p_is_featured` INT(1), IN `_p_is_active` INT(1), IN `_ecat_id` INT(11))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_size` (IN `sizeNameI` VARCHAR(255))  BEGIN
	insert into tbl_size (size_name)
			values (sizeNameI);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_product` (IN `searchSP` VARCHAR(255))  BEGIN
SELECT * FROM tbl_product WHERE p_is_active = 1 AND p_name LIKE searchSP;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_show_category` ()  BEGIN
	select tcat_id,
			tcat_name,
			show_on_menu
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_show_customer` ()  BEGIN
	select * from tbl_customer;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_show_products` ()  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_show_sizes` ()  BEGIN
	select size_id ,
			size_name
	from tbl_size;
END$$
...
(5, 'abraham', '', 'abraham@admin.com', '955446977', 173, 'sdfsdf ', 'huancayo', 'junin', '12001', 'abraham saldaña', 'fdfg', '9555446977', 173, 'sadf asdf', 'huancayo', 'junin', '12001', 'abraham saldaña', 'dfgdfgdf', '9555446977', 173, 'sadf asdf df', 'huancayo', 'junin', '12001', '25f9e794323b453885f5181f1b624d0b', 'acf6070849337ee64654df902900bd44', '2021-06-03 05:49:28', '1622677768', 1),
(11, 'test2', '', 'test2@gmail.com', '94878455', 173, 'sdfg sdfg df', 'huancayo', 'junon', '122001', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', '6ebe76c9fb411be97b3b0d48b791a7c9', '8d066de9f97876032d815e04cb365f2d', '2021-06-08 03:41:16', '1623102076', 0),
(13, 'test2', '', 'test121@gmail.com', '94878455', 173, 'sdfg sdfg df', 'huancayo', 'junon', '122001', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', '6ebe76c9fb411be97b3b0d48b791a7c9', '1ba7eab86085e4a3fe59f3a69462624f', '2021-06-08 03:44:55', '1623102295', 1),
(14, 'test2', '', 'test21@gmail.com', '94878455', 173, 'test2@gmail.comtest2@gmail.com', 'huancayo', 'junin', '12001', 'test', 'asd asd ', '9555446977', 173, 'asd asd ', 'asd', 'asd', '12001', 'abraham saldaña', 'asd asd ', '9555446977', 173, 'asd asd ', 'huancayo', 'junin', '12001', '6ebe76c9fb411be97b3b0d48b791a7c9', '4aaa520fa60731c5707817de050f5a1c', '2021-06-09 07:39:30', '1623202770', 1);
...
(8, 'hols ', 'recivi sdf su prodfusdf', '\r\nCustomer Name: abraham<br>\r\nCustomer Email: abraham@admin.com<br>\r\nPayment Method: Bank Deposit<br>\r\nPayment Date: 2021-06-03 05:54:50<br>\r\nPayment Details: <br>\r\nTransaction Details: <br>dfgdfg<br>\r\nPaid Amount: 50<br>\r\nPayment Status: Pending<br>\r\nShipping Status: Pending<br>\r\nPayment Id: 1622678090<br>\r\n            \r\n<br><b><u>Product Item 1</u></b><br>\r\nProduct Name: Star Wars Darth Vader<br>\r\nSize: S<br>\r\nColor: Red<br>\r\nQuantity: 2<br>\r\nUnit Price: 20<br>\r\n            ', 5);
...
(8, 'Photo', 'Foto'),
(9, 'Login', 'Ingresar'),
(10, 'Customer Login', 'Ingresar Cliente'),
(11, 'Click here to login', 'Click Aqui Para Ingresar'),
(12, 'Back to Login Page', 'Volver A Login'),
(13, 'Logged in as', 'Conectado Como'),
(14, 'Logout', 'Salir'),
(15, 'Register', 'Registro'),
(16, 'Customer Registration', 'Registro Cliente'),
(17, 'Registration Successful', 'Registro Exitoso'),
(18, 'Cart', 'Carro'),
(19, 'View Cart', 'Ver Carro'),
(20, 'Update Cart', 'Actualizar Carro'),
(21, 'Back to Cart', 'Vovler Al Corre'),
(22, 'Checkout', 'Caja'),
(23, 'Proceed to Checkout', 'Pasar por caja'),
(24, 'Orders', 'Pedidos'),
(25, 'Order History', 'Historia Pedido'),
(26, 'Order Details', 'Detalle De Pedido'),
(27, 'Payment Date and Time', 'Fecha y hora de pago'),
(28, 'Transaction ID', 'Transaction ID'),
(29, 'Paid Amount', 'Monto De Pago'),
(30, 'Payment Status', 'Estado De Pago'),
(31, 'Payment Method', 'Metodo De Pago'),
(32, 'Payment ID', 'PAGO ID'),
(33, 'Payment Section', 'Sección De Pago'),
(34, 'Select Payment Method', 'Seleccionar Metodo De Pago'),
(35, 'Select a Method', 'Seleccione Metodo'),
(36, 'PayPal', 'PayPal'),
(37, 'Stripe', 'Stripe'),
(38, 'Bank Deposit', 'Deposito Banco'),
(39, 'Card Number', 'Numero De Tarjeta'),
(40, 'CVV', 'CVV'),
(41, 'Month', 'Mes'),
(42, 'Year', 'Año'),
(43, 'Send to this Details', 'Enviar Estos Detaller'),
(44, 'Transaction Information', 'Información de Transacción'),
(45, 'Include transaction id and other information correctly', 'Incluya correctamente la identificación de la transacción y otra información'),
(46, 'Pay Now', 'Pagar Ahora'),
(47, 'Product Name', 'Nombre De Producto'),
(48, 'Product Details', 'Detalles De Producto'),
(49, 'Categories', 'Categorias'),
(50, 'Category:', 'Categoria:'),
(51, 'All Products Under', 'Todos los productos debajo'),
(52, 'Select Size', 'Selecciona Tamaño'),
(53, 'Select Color', 'Selecciona Color'),
(54, 'Product Price', 'Precio Producto'),
(55, 'Quantity', 'Cantidad'),
(56, 'Out of Stock', 'Agotado'),
(57, 'Share This', 'Compartir Esto'),
(58, 'Share This Product', 'Compartir Este Producto'),
(59, 'Product Description', 'Descripción Producto'),
(60, 'Features', 'Caracteristicas'),
(61, 'Conditions', 'Condiciones'),
(62, 'Return Policy', 'Politica De Devoluciones'),
(63, 'Reviews', 'Reviews'),
(64, 'Review', 'Review'),
(65, 'Give a Review', 'Hacer Review'),
(66, 'Write your comment (Optional)', 'Escribe tu comentario (Opcional)'),
(67, 'Submit Review', 'Enviar Review'),
(68, 'You already have given a rating!', '¡Ya has puntuado!'),
(69, 'You must have to login to give a review', 'Debe tener que iniciar sesión para dar una revisión'),
...
(73, 'No return policy found', 'No se ha encontrado ninguna política de devolución.'),
(74, 'No Review is Found', 'No se ha encontrado ninguna reseña'),
...
(85, 'Continue Shipping', 'Continuar enviando'),
(86, 'Update Billing Address', 'Actualizar dirección de facturación'),
(87, 'Update Shipping Address', 'Actualizar la dirección de envío'),
(88, 'Update Billing and Shipping Info', 'Actualizar la información de facturación y envío'),
...
(94, 'Email Address', 'Dirección de correo electrónico'),
(95, 'Enter Your Email Address', 'Ingrese su dirección de correo electrónico'),
...
(101, 'Retype New Password', 'Reescriba nueva contraseña'),
(102, 'Full Name', 'Nombres'),
(103, 'Company Name', 'Nombre De Empresa'),
...
(112, 'Popular Posts', 'Entradas populares'),
(113, 'Recent Posts', 'Recent Posts'),
(114, 'Contact Information', 'Información del contacto'),
...
(121, 'Congratulation! Payment is successful.', 'Enhorabuena El pago se ha realizado correctamente.'),
(122, 'Billing and Shipping Information is updated successfully.', 'La información de facturación y envío se ha actualizado correctamente.'),
...
(126, 'You must have to select a country.', 'Debe tener que seleccionar un país.'),
...
(130, 'Profile Information is updated successfully.', 'La información del perfil se ha actualizado correctamente.'),
(131, 'Email Address can not be empty', 'La dirección de correo electrónico no puede estar vacía'),
(132, 'Email and/or Password can not be empty.', 'El correo electrónico y / o la contraseña no pueden estar vacíos.'),
(133, 'Email Address does not match.', 'La dirección de Email no coincide.'),
(134, 'Email address must be valid.', 'La dirección de correo electrónico debe ser válida.'),
(135, 'You email address is not found in our system.', 'Su dirección de correo electrónico no se encuentra en nuestro sistema.'),
...
(137, 'Your email is verified successfully. You can now login to our website.', 'Su correo electrónico se verificó correctamente. Ahora puede iniciar sesión en nuestro sitio web.'),
(138, 'Password can not be empty.', 'La contraseña no puede estar vacía.'),
(139, 'Passwords do not match.', 'Las contraseñas no coinciden.'),
(140, 'Please enter new and retype passwords.', 'Ingrese nuevas contraseñas y vuelva a escribirlas.'),
...
(143, 'PASSWORD RESET REQUEST - YOUR WEBSITE.COM', 'SOLICITUD DE RESTABLECER CONTRASEÑA - SUSITIOWEB.COM'),
(144, 'The password reset email time (24 hours) has expired. Please again try to reset your password.', 'El tiempo del correo electrónico para restablecer la contraseña (24 horas) ha expirado. Vuelva a intentar restablecer su contraseña.'),
...
(146, 'Password is reset successfully. You can now login.', 'La contraseña se restableció correctamente. Ahora puede iniciar sesión.'),
(147, 'Email Address Already Exists', 'La dirección de correo ya existe.'),
(148, 'Sorry! Your account is inactive. Please contact to the administrator.', '¡Lo siento! Tu cuenta está inactiva. Comuníquese con el administrador.'),
(149, 'Change Password', 'Cambiar la contraseña'),
(150, 'Registration Email Confirmation for YOUR WEBSITE', 'Confirmación por correo electrónico de registro para SU SITIO WEB.'),
(151, 'Thank you for your registration! Your account has been created. To active your account click on the link below:', '¡Gracias por su registro! Tu cuenta ha sido creada. Para activar su cuenta, haga clic en el enlace a continuación:'),
(152, 'Your registration is completed. Please check your email address to follow the process to confirm your registration.', 'Su registro está completo. Verifique su dirección de correo electrónico para seguir el proceso para confirmar su registro.'),
(153, 'No Product Found', 'Producto No Encontrado'),
(154, 'Add to Cart', 'Agregar Carro'),
...
(158, 'Color', 'Color'),
(159, 'Price', 'Precio'),
(160, 'Please login as customer to checkout', 'Ingresar como cliente para finalizar la compra'),
(161, 'Billing Address', 'Dirección de Envio'),
(162, 'Shipping Address', 'Dirección de Envío'),
(163, 'Rating is Submitted Successfully!', '¡La calificación se envió correctamente!');
...
(49, 1, 'Star Wars Darth Vader', 'S', 'Red', '2', '20', '1622678090'),
(50, 80, 'erte', 'XS', 'Red', '2', '16', '1623203290'),
(52, 80, 'erte', 'XS', 'Red', '1', '16', '1623203361');
...
(43, 1, 'John Doe', 'customer@gmail.com', '2018-02-13 15:34:14', 'ch_1Bv0B5BoKopKik6A2WhDT8UL', 130, '4242424242424242', '234', '12', '2020', '', 'Stripe', 'Completed', 'Completed', '1518514454'),
...
(44, 5, 'abraham', 'abraham@admin.com', '2021-06-03 05:54:50', '', 50, '', '', '', '', 'dfgdfg', 'Bank Deposit', 'Completed', 'Pending', '1622678090'),
(45, 14, 'test2', 'test21@gmail.com', '2021-06-09 07:48:10', '', 42, '', '', '', '', 'asd', 'Bank Deposit', 'Completed', 'Completed', '1623203290'),
(47, 14, 'test2', 'test21@gmail.com', '2021-06-09 07:49:21', '', 26, '', '', '', '', 'sdf', 'Bank Deposit', 'Pending', 'Pending', '1623203361');
...
(77, 'test2', '141', '149', 2, 'product-featured-77.jpg', '<p><strong>Lorem Ipsum</strong> is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum.</p>', '<p><strong>Lorem Ipsum</strong> is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum.<strong>Lorem Ipsum</strong> is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum.</p>', '<p><strong>Lorem Ipsum</strong> is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum.<strong>Lorem Ipsum</strong> is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum.</p>', '<p><strong>Lorem Ipsum</strong> is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum.</p>', '<p><strong>Lorem Ipsum</strong> is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum.<strong>Lorem Ipsum</strong> is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum.</p>', 4, 0, 1, 2),
(80, 'erte', '14', '16', 2, 'product-featured-80.jpg', '', '', '', '', '', 8, 0, 1, 4);
...
--
-- Estructura de tabla para la tabla `tbl_testimonial`
--
...
--
-- Volcado de datos para la tabla `tbl_testimonial`
--
...
(13, 'Admin admin', 'admin@gmail.com', '', '81dc9bdb52d04dc20036dbd8313ed055', 'user-13.jpg', 'Admin', 'Active'),
...
--
-- Indices de la tabla `tbl_testimonial`
--
...
--
-- AUTO_INCREMENT de la tabla `tbl_testimonial`
--
ALTER TABLE `tbl_testimonial`

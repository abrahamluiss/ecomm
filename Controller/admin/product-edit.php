    	...
    	if( isset($_FILES['photo']["name"]) && isset($_FILES['photo']["tmp_name"]) )
        {
            ...
            for($i=0;$i<count($photo);$i++)
            {
		        ...
		        if( $my_ext1=='jpg' || $my_ext1=='png' || $my_ext1=='jpeg' || $my_ext1=='gif' ) {
                    ...
                    move_uploaded_file($photo_temp[$i],"../../View/assets/uploads/product_photos/".$final_name1[$m]);
                    $m++;
                    $z++;
		        }
            }
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4" style="padding-top:4px;">
								<img src="../../View/assets/uploads/<?php echo $p_featured_photo; ?>" alt="" style="width:150px;">
								...
								<table id="ProductTable" style="width:100%;">
			                        <tbody>
			                        	...
			                        	foreach ($result as $row) {
											...
											<tr>
				                                <td>
				                                    <img src="../../View/assets/uploads/product_photos/<?php echo $row['photo']; ?>" alt="" style="width:150px;margin-bottom:5px;">
				                                </td>
				                                <td style="width:28px;">
